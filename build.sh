...
# cmake .. --preset=dev -DKAHYPAR_CI_BUILD=ON -DKAHYPAR_DOWNLOAD_TBB=On # -DKAHYPAR_DOWNLOAD_GMP=On

cmake .. -DCMAKE_C_COMPILER=${HOME}/gcc-13.2/bin/gcc \
